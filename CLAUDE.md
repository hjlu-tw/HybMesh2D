...
observed. The cost is therefore not truncation but **always-loaded context** — **34,373
characters (34,565 bytes, 2026-09-07) ≈ 9k tokens**, paid by every session before it reads a line of
...
**35,500**, leaving 1,127 characters of slack — derived by a rule the gate states at that

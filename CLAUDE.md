...
observed. The cost is therefore not truncation but **always-loaded context** — **37,026
characters (37,242 bytes, 2026-09-23) ≈ 9k tokens**, paid by every session before it reads a line of
...
**38,000**, leaving 974 characters of slack — derived by a rule the gate states at that
...
characters while `wc -c` reports bytes, and the two differ by 216 today because of the CJK in this

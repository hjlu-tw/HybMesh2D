...
observed. The cost is therefore not truncation but **always-loaded context** — **36,697
characters (36,913 bytes, 2026-09-17) ≈ 9k tokens**, paid by every session before it reads a line of
...
**37,500**, leaving 803 characters of slack — derived by a rule the gate states at that

...
observed. The cost is therefore not truncation but **always-loaded context** — **37,955
characters (38,175 bytes, 2026-09-23) ≈ 9k tokens**, paid by every session before it reads a line of
...
**38,500**, leaving 545 characters of slack — derived by a rule the gate states at that

...
observed. The cost is therefore not truncation but **always-loaded context** — **38,297
characters (38,519 bytes, 2026-09-24) ≈ 10k tokens**, paid by every session before it reads a line of
...
**39,000**, leaving 703 characters of slack — derived by a rule the gate states at that
...
characters while `wc -c` reports bytes, and the two differ by 222 today because of the CJK in this
...
- **GUI file length.** Keep each file under `tools/PreProcessor/gui/` at **~500 lines**; split it
  ...
  **four** commits crossed it in the six days after #67 wrote it down — `98003f1` (#85),
  ...
  history. 5 of 278 files exceed it (worst 524); those five are PINNED at their measured sizes,

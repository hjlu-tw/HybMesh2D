...
observed. The cost is therefore not truncation but **always-loaded context** — **37,928
characters (38,148 bytes, 2026-09-23) ≈ 9k tokens**, paid by every session before it reads a line of
...
**38,500**, leaving 572 characters of slack — derived by a rule the gate states at that
...
- **GUI file length.** Keep each file under `tools/PreProcessor/gui/` at **~500 lines**; split it
  ...
  **four** commits crossed it in the six days after #67 wrote it down — `98003f1` (#85),
  ...
  history. 5 of 272 files exceed it (worst 524); those five are PINNED at their measured sizes,

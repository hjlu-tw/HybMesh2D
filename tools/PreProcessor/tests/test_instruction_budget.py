...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Ten rule files now — 47,618 / 47,008 / 45,031 / 36,622 / 25,369 / 18,223 / 15,762 / 12,672 / 12,643 / 8,969  characters (mesher-multiblock, pipeline-case, mesher-smoothing, gui-panels-config, gui-seams, mesher, gui-results, gui-canvas-edit, gui-handoff, gui-lifecycle) — so "moving text into another rule file
    ...
    eight, which have 14,969 / 23,378 / 34,631 / 41,777 / 44,238 / 47,328 / 47,357 / 51,031. #76 spent 3,446 of

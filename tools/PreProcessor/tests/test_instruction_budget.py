...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Ten rule files now — 43,087 / 37,090 / 34,691 / 16,805 / 15,968 / 15,762 / 12,672 / 12,643 / 11,861 / 8,969  characters (pipeline-case, mesher-multiblock, mesher-smoothing, mesher, gui-seams, gui-results, gui-canvas-edit, gui-handoff, gui-panels-config, gui-lifecycle) — so "moving text into another rule file
    is not a legal evasion" only bites for a move larger than the 16,913 / 22,910 of
    headroom the two large ones have left, and not at all for a move into any of the other
    eight, which have 25,309 / 43,195 / 44,032 / 44,238 / 47,328 / 47,357 / 48,139 / 51,031. #76 spent 3,446 of

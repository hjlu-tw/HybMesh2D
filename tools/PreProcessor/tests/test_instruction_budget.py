...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Ten rule files now — 50,112 / 47,008 / 45,018 / 38,554 / 25,369 / 20,957 / 15,762 / 12,672 / 12,643 / 8,969  characters (mesher-multiblock, pipeline-case, mesher-smoothing, gui-panels-config, gui-seams, mesher, gui-results, gui-canvas-edit, gui-handoff, gui-lifecycle) — so "moving text into another rule file
    is not a legal evasion" only bites for a move larger than the 9,888 / 12,992 of
    headroom the two large ones have left, and not at all for a move into any of the other
    eight, which have 14,982 / 21,446 / 34,631 / 39,043 / 44,238 / 47,328 / 47,357 / 51,031. #76 spent 3,446 of

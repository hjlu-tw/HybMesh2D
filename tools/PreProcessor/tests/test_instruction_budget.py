...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Ten rule files now — 46,476 / 43,546 / 38,478 / 19,115 / 16,805 / 15,762 / 12,672 / 12,643 / 11,861 / 8,969  characters (pipeline-case, mesher-multiblock, mesher-smoothing, gui-seams, mesher, gui-results, gui-canvas-edit, gui-handoff, gui-panels-config, gui-lifecycle) — so "moving text into another rule file
    is not a legal evasion" only bites for a move larger than the 13,524 / 16,454 of
    headroom the two large ones have left, and not at all for a move into any of the other
    eight, which have 21,522 / 40,885 / 43,195 / 44,238 / 47,328 / 47,357 / 48,139 / 51,031. #76 spent 3,446 of

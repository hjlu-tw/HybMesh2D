...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Ten rule files now — 47,008 / 43,870 / 38,649 / 21,429 / 16,805 / 16,479 / 15,762 / 12,672 / 12,643 / 8,969  characters (pipeline-case, mesher-multiblock, mesher-smoothing, gui-seams, mesher, gui-panels-config, gui-results, gui-canvas-edit, gui-handoff, gui-lifecycle) — so "moving text into another rule file
    ...
    eight, which have 21,351 / 38,571 / 43,195 / 43,521 / 44,238 / 47,328 / 47,357 / 51,031. #76 spent 3,446 of

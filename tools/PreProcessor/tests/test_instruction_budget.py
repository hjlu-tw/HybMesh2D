...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Ten rule files now — 47,854 / 47,008 / 41,360 / 33,815 / 21,429 / 18,253 / 15,762 / 12,672 / 12,643 / 8,969  characters (mesher-multiblock, pipeline-case, mesher-smoothing, gui-panels-config, gui-seams, mesher, gui-results, gui-canvas-edit, gui-handoff, gui-lifecycle) — so "moving text into another rule file
    is not a legal evasion" only bites for a move larger than the 12,146 / 12,992 of
    headroom the two large ones have left, and not at all for a move into any of the other
    eight, which have 18,640 / 26,185 / 38,571 / 41,747 / 44,238 / 47,328 / 47,357 / 51,031. #76 spent 3,446 of

...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Ten rule files now — 52,081 / 48,211 / 45,018 / 38,862 / 25,369 / 24,425 / 19,806 / 15,762 / 12,672 / 8,969  characters (mesher-multiblock, pipeline-case, mesher-smoothing, gui-panels-config, gui-seams, mesher, gui-handoff, gui-results, gui-canvas-edit, gui-lifecycle) — so "moving text into another rule file
    is not a legal evasion" only bites for a move larger than the 7,919 / 11,789 of

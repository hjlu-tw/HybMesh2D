...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Ten rule files now — 59,722 / 58,537 / 50,084 / 45,018 / 35,517 / 25,369 / 22,516 / 15,762 / 12,672 / 8,969  characters (gui-panels-config, mesher-multiblock, pipeline-case, mesher-smoothing, mesher, gui-seams, gui-handoff, gui-results, gui-canvas-edit, gui-lifecycle) — so "moving text into another rule file
    is not a legal evasion" only bites for a move larger than the 278 / 1,463 of

...
Known remaining blind spots, stated rather than pretended away:
 ...
 d. `RULE_BUDGET` is a flat 60,000 with no ratchet, because #59 fixes the number.
    Eleven rule files now — 58,537 / 50,834 / 45,018 / 39,554 / 35,517 / 28,899 / 25,369 / 22,516 / 15,762 / 12,672 / 8,969  characters (mesher-multiblock, pipeline-case, mesher-smoothing, gui-panels-config, mesher, gui-topology, gui-seams, gui-handoff, gui-results, gui-canvas-edit, gui-lifecycle) — so "moving text into another rule file
    ...
    nine, which have 14,982 / 20,446 / 24,483 / 31,101 / 34,631 / 37,484 / 44,238 / 47,328 / 51,031. #76 spent 3,446 of

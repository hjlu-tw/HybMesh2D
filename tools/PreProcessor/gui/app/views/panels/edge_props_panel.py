...
class EdgePropsPanel(CollapsibleSection):
    def __init__(self, parent=None):
        ...
        self.tri_x0 = QDoubleSpinBox(); self.tri_x0.setRange(-1e6, 1e6); self.tri_x0.setDecimals(4); self.tri_x0.setStyleSheet(SPIN_STYLE)
        self.tri_y0 = QDoubleSpinBox(); self.tri_y0.setRange(-1e6, 1e6); self.tri_y0.setDecimals(4); self.tri_y0.setStyleSheet(SPIN_STYLE)
        self.tri_x1 = QDoubleSpinBox(); self.tri_x1.setRange(-1e6, 1e6); self.tri_x1.setDecimals(4); self.tri_x1.setStyleSheet(SPIN_STYLE)
        self.tri_y1 = QDoubleSpinBox(); self.tri_y1.setRange(-1e6, 1e6); self.tri_y1.setDecimals(4); self.tri_y1.setStyleSheet(SPIN_STYLE)
        self.tri_x2 = QDoubleSpinBox(); self.tri_x2.setRange(-1e6, 1e6); self.tri_x2.setDecimals(4); self.tri_x2.setStyleSheet(SPIN_STYLE)
        self.tri_y2 = QDoubleSpinBox(); self.tri_y2.setRange(-1e6, 1e6); self.tri_y2.setDecimals(4); self.tri_y2.setStyleSheet(SPIN_STYLE)
        ...
        self.quad_x0 = QDoubleSpinBox(); self.quad_x0.setRange(-1e6, 1e6); self.quad_x0.setDecimals(4); self.quad_x0.setStyleSheet(SPIN_STYLE)
        self.quad_y0 = QDoubleSpinBox(); self.quad_y0.setRange(-1e6, 1e6); self.quad_y0.setDecimals(4); self.quad_y0.setStyleSheet(SPIN_STYLE)
        self.quad_x1 = QDoubleSpinBox(); self.quad_x1.setRange(-1e6, 1e6); self.quad_x1.setDecimals(4); self.quad_x1.setStyleSheet(SPIN_STYLE)
        self.quad_y1 = QDoubleSpinBox(); self.quad_y1.setRange(-1e6, 1e6); self.quad_y1.setDecimals(4); self.quad_y1.setStyleSheet(SPIN_STYLE)
        self.quad_x2 = QDoubleSpinBox(); self.quad_x2.setRange(-1e6, 1e6); self.quad_x2.setDecimals(4); self.quad_x2.setStyleSheet(SPIN_STYLE)
        self.quad_y2 = QDoubleSpinBox(); self.quad_y2.setRange(-1e6, 1e6); self.quad_y2.setDecimals(4); self.quad_y2.setStyleSheet(SPIN_STYLE)
        self.quad_x3 = QDoubleSpinBox(); self.quad_x3.setRange(-1e6, 1e6); self.quad_x3.setDecimals(4); self.quad_x3.setStyleSheet(SPIN_STYLE)
        self.quad_y3 = QDoubleSpinBox(); self.quad_y3.setRange(-1e6, 1e6); self.quad_y3.setDecimals(4); self.quad_y3.setStyleSheet(SPIN_STYLE)
